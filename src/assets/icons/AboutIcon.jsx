const AboutIcon = ({className = ""}) => (
  <svg
    ...
    className= {className} 
  >
    <g filter="url(#filter0_dd_65_129)">
      <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_65_129"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        <feBlend
          mode="normal"
          in2="effect1_dropShadow_65_129"
          result="effect2_dropShadow_65_129"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect2_dropShadow_65_129"
          result="shape"
        />
      </filter>
    </defs>
