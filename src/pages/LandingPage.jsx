...
export default function LandingPage() {
  return (
    <div className="fixed w-1/4 bg-zinc-950 text-white font-Manrope-Regular flex flex-col rounded-lg items-center gap-6 py-4 border-2 border-zinc-800 max-h-screen">
      ...
      <div className="text-white font-Manrope-thin flex flex-col gap-20 pt-10">
